#!/bin/bash
EXEC=problema
TESTS_NO_PROBLEMS=(20 10 20)
PROBLEMS_NO=3
TOTAL=0
WORKING_DIR=`pwd`
array_points=(0 0 0 0)
array_points_per_test=(0 2.5 6 3.5)
max_array_points=(0 50 60 70)
leak_check=0
...
function check_test() {
	...
	if ([ $problem_no -eq 2 ] && [ $test_no -eq 7 ]) || [ $test_no -eq 17 ]; then
